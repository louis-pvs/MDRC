...
class Typography extends PureComponent {
  ...
  static Caption = props => (
    <BaseTypography className="mdc-typography--caption" htmlTag="span" {...props} />
  );
  static Button = props => (
    <BaseTypography className="mdc-typography--button" htmlTag="span" {...props} />
  );
  static Overline = props => (
    <BaseTypography className="mdc-typography--overline" htmlTag="span" {...props} />
  );
